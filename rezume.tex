...
\section{Projects}
  \resumeHeadingListStart{}
      ...
      \resumeTrioHeading{\href{https://github.com/NandiniNichite/book-recommender-system}{\uline{ReadNexus}}}{Python, Flask, SBERT, Pandas, Jinja, Bootstrap}{\href{https://github.com/NandiniNichite/book-recommender-system}{\uline{Source Code}}}
        \resumeItemListStart{}
          \resumeItem{Built a full-stack book recommendation system using \textbf{fuzzy searching}, summary based  \textbf{semantic querying}, \textbf{collaborative filtering}, and popularity-based ranking}
          ...
          \resumeItem{Processed dataset of 300K+ Books; Implemented \textbf{mobile friendly}, responsive and interactive UI with \textbf{dark mode}}
        \resumeItemListEnd{}
        
        \resumeTrioHeading{\href{https://frost2k5.is-a.dev/SmartSpend}{\uline{SmartSpend}}}{MERN Stack, JWT, Chart.js, Azure App Service}{\href{https://github.com/FrosT2k5/SmartSpend}{\uline{Source Code}}}
        \resumeItemListStart{}
          \resumeItem{Designed and deployed a personal finance manager Web \textbf{SPA} with \textbf{investment} and \textbf{expense tracking}}
          ...
          \resumeItem{Used \textbf{Chart.js} for visual financial insights; deployed on \textbf{Azure App Service} with 99.9\% uptime.}
        \resumeItemListEnd{}
        ...
        \resumeItemListStart{}
            ...
            \resumeItem{\href{https://github.com/FrosT2k5/AirQualitySensor}{\uline{AirQualitySensor}} – ESP32 (C++) + TS + React/ChakraUI; real-time pollution monitoring with multiple sensors.}
