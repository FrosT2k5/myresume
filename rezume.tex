...
\resumeHeadingListStart{}
  ...
  {Center of Excellence (CoE) in Complex and NonLinear Dynamic Systems (CNDS) - \textbf{VJTI}}{}
    \resumeItemListStart{}
      ...
      \resumeItem{Developed a local cellular network testbed using \textbf{SDR} and open-source stacks like srsRAN, OpenLTE, OpenBTS, YatesBTS, and OpenAirInterface}
...
\section{Projects}
  \resumeHeadingListStart{}
      ...
      \resumeTrioHeading{\href{https://github.com/NandiniNichite/book-recommender-system}{\uline{ReadNexus}}}{Python, Flask, SBERT, Pandas, Jinja}{\href{https://github.com/NandiniNichite/book-recommender-system}{\uline{Source Code}}}
        \resumeItemListStart{}
          \resumeItem{Built a full-stack book recommendation system using \textbf{semantic search}, \textbf{collaborative filtering}, and popularity-based ranking}
          \resumeItem{Used \textbf{SBERT embeddings} + cosine similarity for query-based recommendations on a dataset of 3L+ books and 40K+ summaries}
          \resumeItem{Implemented \textbf{fuzzy title matching}, interactive search flows, and a \textbf{clean UI} with \textbf{dark mode}}
        \resumeItemListEnd{}
        
        \resumeTrioHeading{\href{https://frost2k5.is-a.dev/SmartSpend}{\uline{SmartSpend}}}{MERN Stack, JWT, Chart.js, Azure App Service}{\href{https://github.com/FrosT2k5/SmartSpend_Backend}{\uline{Source Code}}}
        \resumeItemListStart{}
          \resumeItem{Designed and deployed a personal finance manager with \textbf{investment} and \textbf{expense tracking}}
          \resumeItem{Implemented secure \textbf{JWT auth} with auto-renewal via \textbf{HTTPS cookies} and a SwaggerUI-documented REST API}
          \resumeItem{Used \textbf{Chart.js} for visual financial insights; deployed on \textbf{Azure App Service}}
        \resumeItemListEnd{}
        ...
        \resumeItemListStart{}
            ...
            \resumeItem{\href{https://github.com/FrosT2k5/AirQualitySensor}{\uline{AirQualitySensor}} – ESP32 (C++) + React dashboard; real-time pollution monitoring with multiple sensors.}
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{Python, JavaScript, Java, C/C++, Bash}
    \resumeSectionType{Frameworks}{:}{Django, Flask, React, Node.js, Express, SQLAlchemy, Mongoose, Bootstrap, REST APIs, JWT}
    \resumeSectionType{Tools}{:}{Git, Docker, Azure, CI/CD,  Swagger/OpenAPI, GNU/Linux utilities}
  \resumeHeadingListEnd{}
